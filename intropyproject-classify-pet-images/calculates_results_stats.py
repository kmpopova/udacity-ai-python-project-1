...
def calculates_results_stats(results_dic):
    ...
    n_dogs_img = sum([1 for key in results_dic.keys() if results_dic[key][3] == 1])
    n_notdogs_img = n_images - n_dogs_img
    n_match = sum([1 for key in results_dic.keys() if results_dic[key][2] == 1])
    n_correct_dogs = sum([1 for key in results_dic.keys() if results_dic[key][3] == 1\
    and results_dic[key][4] == 1])
    n_correct_notdogs = sum([1 for key in results_dic.keys() if results_dic[key][3] == 0\
    and results_dic[key][4] == 0])
    n_correct_breed = sum([1 for key in results_dic.keys() if results_dic[key][3] == 1\
    and results_dic[key][2] == 1])
